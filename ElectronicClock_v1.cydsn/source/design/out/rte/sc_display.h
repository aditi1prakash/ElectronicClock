 ...
 * @param const sc_display_data_t * const value: Pointer to initial value of the application data
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
inline RC_t RTE_SC_DISPLAY_init( SC_DISPLAY_t * const signal, const SC_DISPLAY_data_t * const value )
{                                                                                                                      
