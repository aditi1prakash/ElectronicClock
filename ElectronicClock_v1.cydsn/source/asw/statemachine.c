                        ...
                        CLOCK_state_t* state)
{
    ...
    CLOCK_state_t currentState = *state;
    CLOCK_state_t toState = currentState; //Just in case
    
    UART_LOG_PutString("Current State: ");
    switch(currentState)
    {
        case STATE_CLOCK_C_ISDISPLAYING:
        UART_LOG_PutString("C_ISDISPLAYING\n");
        break;
        case STATE_CLOCK_C_ISEDITINGHOURS:
        UART_LOG_PutString("C_ISEDITINGHOURS\n");
        break;
        case STATE_CLOCK_C_ISEDITINGMINUTES:
        UART_LOG_PutString("C_ISEDITINGMINUTES\n");
        break;
        case STATE_CLOCK_W_ISDISPLAYING:
        UART_LOG_PutString("W_ISDISPLAYING\n");
        break;
        case STATE_CLOCK_W_ISEDITING:
        UART_LOG_PutString("W_ISEDITING\n");
        break;
        case STATE_CLOCK_W_ISAUTOINCREMENT:
        UART_LOG_PutString("W_ISAUTOINCREMENT\n");
        break;
        default:
        UART_LOG_PutString("Default case\n");
        break;
    }
