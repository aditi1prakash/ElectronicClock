// ======================================================================
// ElectronicClock_v1.v generated from TopDesign.cysch
// 07/25/2021 at 19:33
...
module SPI_Master_v2_50_1 (
	...
	cy_clock_v1_0
		#(.id("8c2b9293-76a9-45ac-933a-c733c2160f04/426fcbe0-714d-4404-8fa8-581ff40c30f1"),
		  .source_clock_id(""),
		  .divisor(0),
...
module top ;
	...
	wire [0:0] tmpOE__Pin_ButtonLeft_net;
	wire [0:0] tmpIO_0__Pin_ButtonLeft_net;
	wire [0:0] tmpINTERRUPT_0__Pin_ButtonLeft_net;
	electrical [0:0] tmpSIOVREF__Pin_ButtonLeft_net;
	...
	cy_psoc3_pins_v1_10
		...
		Pin_ButtonLeft
		 (.oe(tmpOE__Pin_ButtonLeft_net),
		  .y({1'b0}),
		  .fb({Net_3}),
		  .io({tmpIO_0__Pin_ButtonLeft_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_ButtonLeft_net),
		  .interrupt({tmpINTERRUPT_0__Pin_ButtonLeft_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_ButtonLeft_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_ButtonRight_net;
	wire [0:0] tmpIO_0__Pin_ButtonRight_net;
	wire [0:0] tmpINTERRUPT_0__Pin_ButtonRight_net;
	electrical [0:0] tmpSIOVREF__Pin_ButtonRight_net;

	cy_psoc3_pins_v1_10
		#(.id("b5e604ee-c29c-45bb-b935-2cb01d6ec230"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_ButtonRight
		 (.oe(tmpOE__Pin_ButtonRight_net),
		  .y({1'b0}),
		  .fb({Net_4}),
		  .io({tmpIO_0__Pin_ButtonRight_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_ButtonRight_net),
		  .interrupt({tmpINTERRUPT_0__Pin_ButtonRight_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_ButtonRight_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("732ca013-f40f-45a9-9fb2-866b8e1d8a39"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("200000000000"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("5912a14c-119b-4a2c-83fd-14aa1486afc5"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("2d8c57cd-6bb7-4843-aa8d-53670b4506a9"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("fe2b3e0d-9cb8-47db-848b-8298e2962783"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("8995774d-cf78-4ebf-8ed7-ab8413ee92ab"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("1f002763-e7cf-479d-a7ca-7bfc644f84a0"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
